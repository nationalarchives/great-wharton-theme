    ...
    <div class="row">
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <!-- school -->
                <div class="info">
<!--                    <a href="--><?php //echo esc_url( home_url( '/' ) ); ?><!--" title="Back to Great Wharton">-->
<!--                        <div class="close"><i class="fa fa-times fa-2x"></i></div>-->
<!--                    </a>-->

                    <div class="inner">
                        <img src="<?php bloginfo("stylesheet_directory");?>/images/tna-wharton-title.png" alt="Welcome to Great Wharton"  class="title">
